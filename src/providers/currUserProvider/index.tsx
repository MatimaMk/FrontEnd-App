...
import { CurrentUserActionContext, CurrentUserStateContext, INITIAL_STATE } from "./context";
import { getAxiosInstace } from "@/utils/axiosInstance";
import { getCurrentUserError, getCurrentUserPending, getCurrentUserSuccess } from "./actions";
...
function CurrentUserState() {
  ...
  if (!context) {
    throw new Error("CurrentUserStateContext must be used within a CurrentUserProvider");
  }
  return context;
}
...
function CurrentUserAction() {
  ...
  if (!context) {
    throw new Error("CurrentUserActionContext must be used within a CurrentUserProvider");
  }
  return context;
}
